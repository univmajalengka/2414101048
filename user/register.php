...
<head>
  ...
  <title>Daftar | Jossmen Laundry</title>
    ...
    <main class="flex-1 flex items-center justify-center px-4 py-10">
      <div class="max-w-md w-full">
        <div class="bg-white border border-gray-200 rounded-2xl shadow-xl overflow-hidden">
          <div class="bg-gradient-to-r from-pink-500 to-pink-400 text-white px-6 py-6">
            <h1 class="text-2xl font-semibold">Buat Akun</h1>
            <p class="text-sm text-pink-100">
              Daftarkan akun untuk memesan layanan laundry lebih mudah.
            </p>
          </div>
          <form
            action="../services/registerService.php"
            method="POST"
            class="px-6 py-8 space-y-6">
            <div>
              <label for="username" class="block text-sm font-medium mb-2 text-slate-600">Username</label>
              <input
                type="text"
                id="username"
                name="username"
            ...
            <div>
              <label for="password" class="block text-sm font-medium mb-2 text-slate-600">Kata Sandi</label>
              <input
                type="password"
                id="password"
                name="password"
            ...
            <div class="text-center text-xs text-slate-500">
              Sudah punya akun?
              <a href="login.php" class="text-pink-500 hover:underline">Masuk di sini</a>
            </div>
          </form>
        </div>
